...
//using Content.Shared._Goobstation.Contraband; //Euphoria | No contraband detector
...
public sealed class SlasherIncorporealCameraSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        //SubscribeLocalEvent<ContrabandDetectorComponent, PreventCollideEvent>(OnContrabandDetectorPreventCollide); //Euphoria | No contraband detector
    }
    ...
    // Euphoria | No contraband detectors
